...
<head>
<meta charset="UTF-8">
<title>편의점 위치 확인</title>
<link rel="stylesheet" href="../resources/css/pyeonFind.css">
</head>
<body>
    <!DOCTYPE html>
    <html>
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=e8c24d9932a20c924b53d8a99a77e2f3&libraries=services"></script>
    <script>
    // 마커를 담을 배열입니다
    var markers = [];
