...
<body>
	<header>
		<div class="header-container">
			<h1>
				<a href="#"><img onclick="location.href='/'"
					src="/resources/images/logo.png"></a>
			</h1>
			<nav class="main-navigation">

				<a href="/search/move.kh"><i class="fa-solid fa-magnifying-glass icon"></i></a>
				...
				<c:if test="${sessionScope.loginUser eq null}">
					<a href="/member/joinView.kh"><i
						class="fa-regular fa-user icon"></i></a>
				</c:if>



				<c:if test="${not empty sessionScope.loginUser}">
					<a href="/member/myPage.kh"><i class="fa-solid fa-user icon"></i></a>
				</c:if>
	...
	<nav class="board-navigation">
		<div class="board-container">
			<ul>
				...
				<li><a
					href="/search/mainSearch.kh?mainCondition=mael&listCondition=${listCondition}"
					class="board-menu">식사</a></li>
				<li><a
					href="/search/mainSearch.kh?mainCondition=relish&listCondition=${listCondition}"
					class="board-menu">술안주</a></li>
				<li><a
					href="/search/mainSearch.kh?mainCondition=dessert&listCondition=${listCondition}"
					class="board-menu">간식</a></li>
				<li><a
					href="/search/mainSearch.kh?mainCondition=drink&listCondition=${listCondition}"
		...
		<div class="swiper mySwiper">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<img src="/resources/images/sample5.jpg">
				</div>
				<div class="swiper-slide">
				...
				<div class="swiper-slide">
					<img src="/resources/images/sample4.jpg">
				</div>
				<div class="swiper-slide">
					<img src="/resources/images/sample5.jpg">
				</div>
			...
			<div class="footer_content_first">
				<div class="footer_content left">
					...
					<div>
						...
						<button class="learn-more" onclick="onPeon();">
							...
							</span> <span class="button-text">편의점 위치 찾기</span>
						</button>
				...
				<div class="footer_content right">
					...
					<p class="footer_content_sub_txt">
						...
						asdf@asdf.com | image: <a href="http://Freepik.com"
