...
//	public List<Recipe> search3patternList(SqlSessionTemplate session, String listCondition, String mainCondition);
	//메인 분류 4가지와 합쳐서 조회
	public List<Recipe> mainSearch(SqlSessionTemplate session, String mainCondition, String listCondition, String serchValue, String hachCondition, String searchCondition);
	//select 합쳐서
